        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <GlassCard className="p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-500 uppercase tracking-wider">Email</p>
                    <a href="mailto:iccc2027@cet.ac.in" className="text-base text-gray-900 hover:text-blue-600 transition-colors">
                      iccc2027@cet.ac.in
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-500 uppercase tracking-wider">Conference Website</p>
                    <a href="https://iccc2027.cet.ac.in" target="_blank" rel="noopener noreferrer" className="text-base text-gray-900 hover:text-blue-600 transition-colors">
                      iccc2027.cet.ac.in ↗
                    </a>
                  </div>
                </div>
          ...
          <GlassCard className="p-6 sm:p-8">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <a
                href="tel:+919495135213"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-300 text-blue-600 text-sm font-medium hover:bg-blue-200 transition-all duration-200"
              >
                <FiPhone size={14} />
                +91 9495135213
              </a>
              <a
                href="mailto:iccc2027@cet.ac.in"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-300 text-blue-600 text-sm font-medium hover:bg-blue-200 transition-all duration-200"
              >
                <FiMail size={14} />
                iccc2027@cet.ac.in
